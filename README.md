...
| `code/accomplishment.html` | Accomplishment per-page Head tab (slug `/publications`), pasted as-is |
...
| `css/publications.css` | linked from `code/accomplishment.html`, pinned jsDelivr URL |
| `css/projects.css` | linked from `code/accomplishment.html`, pinned jsDelivr URL |
...
| `js/home-video-play.js` | linked from `code/global.html`, pinned jsDelivr URL |
| `js/date-format.js` | linked from `code/global.html`, pinned jsDelivr URL |
